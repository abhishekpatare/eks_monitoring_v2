...
#     logger.debug((pod.namespace,pod.pod_name,pod.cpu_request))
# for _,pod in pod_data.items():
#     logger.debug((pod.namespace,pod.pod_name,pod.memory_request))
# for _,pod in pod_data.items():
#     logger.debug((pod.namespace,pod.pod_name,pod.cpu_limit))
# for _,pod in pod_data.items():
#     logger.debug((pod.namespace,pod.pod_name,pod.memory_limit))
# for _,pod in pod_data.items():
#     logger.debug((pod.namespace,pod.pod_name,pod.cpu_usage))
# for _,pod in pod_data.items():
#     logger.debug((pod.namespace,pod.pod_name,pod.memory_usage))
# for _,pod in pod_data.items():
#     logger.debug((pod.namespace,pod.pod_name,pod.network_rx_bytes))
# for _,pod in pod_data.items():
#     logger.debug((pod.namespace,pod.pod_name,pod.network_tx_bytes))
# for _,pod in pod_data.items():
#     logger.debug((pod.namespace,pod.pod_name,pod.disk_total_bytes))